...
export const AuthPage = ({ onContinue, onBack }: AuthPageProps) => {
  ...
  return (
    <OnboardingLayout maxWidth="max-w-md" onBack={onBack}>
      <BlurText>
      ...
      <div className="relative bg-white/10 backdrop-blur-xl border border-white/15 shadow-2xl shadow-black/60 px-6 py-6 md:px-8 md:py-8">
