...
export const InterestsStep = ({
  ...
  return (
    <OnboardingLayout maxWidth="max-w-5xl" onBack={onBack} wideMask={true}>
          ...
          {INTEREST_CARDS.map((card) => {
            ...
            return (
              <button
                ...
                className={`group text-left p-4 border rounded-2xl transition-all bg-white/10 backdrop-blur-md hover:border-red-400 hover:bg-red-500/10 ${
                  selected
                    ? "border-accent shadow-[0_0_40px_rgba(167,45,37,0.35)] bg-accent/20"
                    : "border-white/15"
                }`}
              >
