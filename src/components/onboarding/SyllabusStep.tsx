...
export const SyllabusStep = ({
  ...
  return (
    <OnboardingLayout maxWidth="max-w-3xl" onBack={onBack}>
      ...
      <div className="bg-white/10 backdrop-blur-xl border border-white/15 px-6 py-6 md:px-8 md:py-8">
        ...
        <div className="mb-6">
          <div className="flex gap-2">
            ...
            <button
              type="button"
              className="px-4 py-2 text-xs uppercase tracking-[0.18em] border border-white/20 bg-white/10 text-white rounded-full backdrop-blur-md hover:bg-accent hover:border-accent hover:text-white transition-colors"
                ...
                <button
                  ...
                  className={`px-3 py-1 text-xs border rounded-full transition-colors ${
                    selected
                      ...
                      : "bg-white/5 text-white/80 border-white/20 hover:bg-accent hover:border-accent hover:text-white"
                  }`}
                >
                  {topic}
                </button>
